...
export default function App() {
  ...
  return (
    <div style={{
        ...
        <div style={{ maxWidth: 1360, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", height: 52 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="8" stroke="#e8eaed" strokeWidth="4" fill="none" strokeDasharray="37.7 12.57" strokeDashoffset="-18.84"/>
              <g transform="translate(1.2,1.2)"><circle cx="12" cy="12" r="8" stroke="#0ea5c9" strokeWidth="4" fill="none" strokeDasharray="10.5 39.77" strokeDashoffset="-7.28"/></g>
            </svg>
            <span style={{ fontSize: 17, fontWeight: 800, letterSpacing: "-.02em", color: "#e8eaed" }}>QuarterlyTax</span>
          </div>
      ...
      <div style={{ borderTop: "1px solid #2a2e3a", padding: "14px 30px", textAlign: "center", fontSize: 11, color: "#828a96" }}>
